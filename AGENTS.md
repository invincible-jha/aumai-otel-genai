# Agent Instructions for OtelGenai

## Project Context
OtelGenai is an open source Standard GenAI telemetry instrumentation for OpenTelemetry.

## Repository Layout
- `src/aumai_otel_genai/` — package source
